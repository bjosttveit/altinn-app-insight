...
c.FileContentsManager.root_dir = "./notebooks"
...
c.LanguageServerManager.language_servers = {
    "pyright": {
        ...
        "config_schema": {
            "type": "object",
            "properties": {
                "python.analysis.stubPath": {"type": "string"},
                "python.analysis.useLibraryCodeForTypes": {"type": "boolean"},
            },
        },
        "workspace_configuration": {
            "python.analysis.stubPath": os.path.join(os.getcwd(), "typings"),
        },
    }
}
...
#  Choices: any of ['sha224', 'sha512', 'shake_256', 'sha3_384', 'sha1', 'sha3_512', 'sm3', 'sha384', 'sha3_224', 'sha512_224', 'sha256', 'shake_128', 'md5', 'ripemd160', 'sha3_256', 'sha512_256', 'md5-sha1', 'blake2s', 'blake2b']
#  Default: 'sha256'
...
#  Choices: any of ['sha224', 'sha3_512', 'sha384', 'sha256', 'sha3_256', 'sha3_224', 'blake2s', 'md5', 'sha512', 'sha3_384', 'sha1', 'blake2b']
#  Default: 'sha256'
